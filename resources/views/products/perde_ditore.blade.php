      ...
      <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/tepiha" title="Tepiha online Kosove, tepiha cilësore Lipjan"><i class="bi bi-grid-3x3-gap me-2"></i>Tepiha</a></li>
            <li class="dropdown-submenu">
              <a class="dropdown-item dropdown-toggle" href="#" title="Perde online Kosove, perde bambus, perde kumash, perde sheqer, perde cenova, sistem amerikan, perde ditore, perde anësore" data-bs-toggle="dropdown"><i class="bi bi-columns-gap me-2"></i>Perde</a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="/anesore" title="Perde anësore online, perde anësore Kosove, perde anësore Lipjan, perde anësore cilësore">Perde Anësore</a></li>
                <li><a class="dropdown-item active" href="/perde-ditore" title="Perde ditore online, perde ditore bambus, perde ditore kumash, perde ditore sheqer, perde ditore cenova, perde ditore sistem amerikan, perde ditore Kosove, perde ditore Lipjan">Perde Ditore</a></li>
              </ul>
            </li>
