...
<head>
  ...
  <!-- CANONICAL URL -->
  <link rel="canonical" href="{{ url('/garnishte') }}">
  ...
  <meta property="og:title" content="Garnishte moderne & praktike – Brillant Lipjan">
  <meta property="og:description" content="Garnishte të qëndrueshme dhe elegante për kuzhinë dhe ambientet e shtëpisë. Zgjedhja perfekte nga Brillant.">
  <meta property="og:url" content="{{ url('/garnishte') }}">
  <meta property="og:image" content="{{ asset('images/og-garnishte.jpg') }}">

  <!-- TWITTER CARD -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Garnishte moderne & praktike – Brillant Lipjan">
  <meta name="twitter:description" content="Materiale cilësore dhe dizajn modern për çdo ambient.">
  <meta name="twitter:image" content="{{ asset('images/og-garnishte.jpg') }}">
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "CollectionPage",
    "name": "Garnishte moderne – Brillant Lipjan",
    "description": "Garnishte cilësore dhe moderne për kuzhinë, sallon dhe dhoma, me materiale rezistente dhe dizajn elegant.",
    "url": "{{ url('/garnishte') }}",
    "image": "{{ asset('images/og-garnishte.jpg') }}",
    "inLanguage": "sq",
    "isPartOf": {
      "@type": "WebSite",
      "name": "B-Brillant",
...
<section class="seo-text mt-5" style="font-size:16px; line-height:1.6;">
  <div class="container">
    <h2>Garnishte për Perde – Aksesorë Elegantë për Përfundimin Perfekt</h2>

    <p>Garnishtet nga Brillant janë elementi i fundit që i jep perdeve tuaja një pamje të kompletuar, elegante dhe profesionale. Koleksioni ynë përfshin shiritë për perde, mbajtëse dekorative, unaza, rripa dhe aksesorë funksionalë që kombinohen me çdo lloj perdeje.</p>

    <p>Çdo garniturë është përzgjedhur me kujdes për të ofruar cilësi të lartë, rezistencë dhe dizajn modern. Ato janë të përshtatshme për perde ditore, perde anësore, perde blackout dhe çdo stil tjetër të dekorimit të shtëpisë. Garnishtet tona jo vetëm e përmirësojnë funksionin e perdeve, por i shtojnë dhomës hijeshi dhe detaje estetike që bien në sy.</p>
