...
<head>
    <meta charset="UTF-8">
    <title>Rivendos Fjalëkalimin - Brillant</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5">
                <div class="card">
                    ...
                    <h4 class="text-center fw-bold text-danger mb-4">Ndrysho fjalëkalimin</h4>
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-danger">
                                <i class="fas fa-unlock-alt me-2"></i> Rivendos fjalëkalimin
                            </button>
                        </div>
                    </form>
